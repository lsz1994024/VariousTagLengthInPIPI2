 ...
 *
 */
public class IndexSorterInt implements Comparator<Integer>{
     ...
     * @param text
     */
    public IndexSorterInt(int[] values, Integer[] indexes){
        this.values = values;
    ...
    public int compare(Integer arg0, Integer arg1) {
        return Integer.compare(values[arg0], values[arg1]);
    }
